...
namespace DevFreela.Payments.API.Consumers
{
    ...
    {
        private const string PROCESSING_PAYMENT_QUEUE = "Payments";
        private const string APPROVED_PAYMENT_QUEUE = "PaymentsApproved";
        ...
        public ProcessPaymentConsumer(IServiceProvider serviceProvider)
        {
            ...
            _channel.QueueDeclare(
                queue: PROCESSING_PAYMENT_QUEUE,
                durable: false,
                exclusive: false,
                autoDelete: false,
                arguments: null);
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (sender, eventArgs) =>
            {
                ...
                _channel.BasicPublish(
                    exchange: "",
                    routingKey: APPROVED_PAYMENT_QUEUE,
            ...
            _channel.BasicConsume(PROCESSING_PAYMENT_QUEUE, false, consumer);
